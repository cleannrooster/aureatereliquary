...
public class GaleswordProjectile extends ThrownItemEntity{

    boolean squall;
    LivingEntity target2;

    public GaleswordProjectile(EntityType<? extends ThrownItemEntity> entityType, World world) {
        super(entityType, world);
    }
    public GaleswordProjectile(World world, LivingEntity owner, boolean squall1, @Nullable LivingEntity target) {
        super(aureate.GALESWORD_PROJECTILE_ENTITY_TYPE, owner, world); // null will be changed later
        this.squall = squall1;
        this.target2 = target;
    }
    public GaleswordProjectile(World world, double x, double y, double z) {
        super(aureate.GALESWORD_PROJECTILE_ENTITY_TYPE, x, y, z, world); // null will be changed later
    }
